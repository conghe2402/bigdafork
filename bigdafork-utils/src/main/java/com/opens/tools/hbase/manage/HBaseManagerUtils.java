...
import com.opens.common.util.FastjsonUtils;
import com.opens.common.util.HBaseConnect4Ready;
import lombok.Data;
 ...
 */
public class HBaseManagerUtils {
    ...
    public HBaseManagerUtils(Properties properties) {
        if (properties != null) {
            ...
            System.setProperty(BigdataUtilsGlobalConstants.JVM_CONTEXT_PROPERTIES,
                    propertiesJsonStr);
        }
        initialize();
    }
    ...
    public Configuration getEnvConfiguration() {
        return HBaseConfiguration.create(this.configuration);
    }
    ...
    private void initialize() {
        ...
        HBaseConnect4Ready connectionWork = new HBaseConnect4Ready(this.configuration);
        connectionWork.ready();
    }
