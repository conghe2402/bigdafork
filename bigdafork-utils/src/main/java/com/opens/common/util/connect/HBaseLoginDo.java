...
import com.opens.common.exceptions.InvalidLoginInfoException;
...
/**
 * This is a hbase login module of hadoop platform using kerberos authentication.
 ...
 */
public class HBaseLoginDo extends BasicObservable implements IDo<Configuration, Configuration> {
    private static final Logger LOGGER = LoggerFactory.getLogger(HBaseLoginDo.class);
    ...
    public HBaseLoginDo(Observer observer) {
        super(observer);
    }
    ...
    private static class JaasConfiguration extends javax.security.auth.login.Configuration {
        ...
        static {
            String jaasEnvVar = System.getProperty(BigdataUtilsGlobalConstants.HBASE_JAAS_DEBUG);
